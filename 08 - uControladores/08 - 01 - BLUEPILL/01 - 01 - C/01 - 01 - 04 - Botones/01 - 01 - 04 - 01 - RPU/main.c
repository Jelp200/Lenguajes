...
GPIO_Mode_IPU -> Input-Pull-Up es un modo el cual nos permite configurar nue_
								 stra resistencia interna de manera que al momento de tener
								 un botón la entrada de corriente a nuestro uC es negativa o
								 0.
*/
