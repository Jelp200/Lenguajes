...
|    ESPACIO DE MEMORIA    | DATOS INGRESADOS |
| :----------------------: | :--------------: |
| 0x[Dirección de memoria] |        13        |
...
> **Nota 1:** El operador `&` permite visualizar la dirección de memoria en la cual se guardo el valor declarado.
...
## [Apuntadores](./14%20-%2001%20-%20espacioMemoriaVariable.c)
...
|    ESPACIO DE MEMORIA    | DATOS INGRESADOS  |
| :----------------------: | :---------------: |
| 0x[Dirección de memoria] | VariableApuntador |
...
```C
int *pVarInt1, *pVarInt2;		// Variables tipo apuntador enteras
float *pVarFloat1, *pVarFloat2;	// Variables tipo apuntador flotantes
char *pCharVar1, *pCharVar2;	// Variables tipo apuntador de caracter
```
...
### [Paso de parámetros por valor](./14%20-%2003%20-%20pasoDeParametrosPorValor.c)
...
### [Paso de parámetros por referencia](./14%20-%2004%20-%20pasoDeParametrosPorReferencia.c)
...
### [Paso de parámetros de arreglos](./14%20-%2005%20-%20parametrosArreglos.c)
...
## [Apuntadores con arreglos](./14%20-%2006%20-%20apuntadoresConArreglos.c)
