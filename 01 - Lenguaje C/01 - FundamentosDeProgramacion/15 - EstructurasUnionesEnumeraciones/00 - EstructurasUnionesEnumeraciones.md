...
## [Estructuras](./15%20-%2001%20-%20Estructuras.c)
...
- Operador `.`: Proporciona un acceso directo a los miembros de la estructura, su sintaxis es:

```C
varStruct_n.miembro_n = Dato;
```

- Operador `->`: Permite acceder a los datos de la estructura a partir de un puntero, su sintaxis es:

```C
varStruct_n -> miembro_n = Dato;
```

### [Estructuras anidadas](./20%20-%2002%20-%20estructurasAnidadas.c)
...
### [Estructuras y funciones](./20%20-%2003%20-%20estructurasFunciones.c)
...
## [Uniones](./20%20-%2004%20-%20Uniones.c)
...
## [Enumeraciones](./20%20-%2005%20-%20Enumeraciones.c)
