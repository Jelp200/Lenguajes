%{
** ######################################################################################################
**      Archivo: 03 - 16 - EspectroSenhalFiltradaBLI.m
**      SO: Windows 10
**      Herramienta: Visual Studio Code
**                   MATLAB R2023a
**
**      Notas:
**          En esta parte de la practica se visualizara el espectro de la señal modulada de la BLI.
** ######################################################################################################
%}
...
title('Espectro de la señal modulada de BLI')
xlabel('f')
ylabel('F(t)')
grid on