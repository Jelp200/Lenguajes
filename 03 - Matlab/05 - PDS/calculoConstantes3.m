%{
** ######################################################################################################
**      Archivo: 04 - CalculoConstantes1.m
**      SO: Windows 10
...
CPX1 = 0.16 * (cos(angRadCPX1) + 1i * sin(angRadCPX1))             % Resultado ~= -0.08 - 0.1386i

%* b
angGradCPX2 = 120;
angRadCPX2 = deg2rad(angGradCPX2);
CPX2 = 0.16 * (cos(angRadCPX2) + 1i * sin(angRadCPX2))             % Resultado ~= -0.08 + 0.1386i

%* e
angGradCPX3 = -180;
angRadCPX3 = deg2rad(angGradCPX3);
CPX3 = .064 * (cos(angRadCPX3) + 1i * sin(angRadCPX3))             % Resultado ~= -0.0640 - 0.0000i

%* f
angGradCPX4 = 180;
angRadCPX4 = deg2rad(angGradCPX4);
CPX4 = .064 * (cos(angRadCPX4) + 1i * sin(angRadCPX4))             % Resultado ~= -0.0640 + 0.0000i

z = -0.84176;                                                      % Valor de z
w = -0.53232;                                                      % Valor de w
